...
public class EditSpacificForm extends JFrame
{
	private JTextField name;
	private JTextField number;
	private JLabel m_numberlabel;
	
	public EditSpacificForm(String i_Name) 
	{
		...
		JLabel lblAddremove = new JLabel("Add "+i_Name);
		...
		btnAdd.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) 
			{
				if(!name.getText().equals(""))
				{
					...
					{
						ScreenMagment.AddProudctToList(name.getText(), i_Name);
					...
					{
						if(!ScreenMagment.IsEmploye(number.getText()))
						{
							if(i_Name.contentEquals("Manger"))
							{
								ScreenMagment.AddEmploye(name.getText(), number.getText(),true);
								JOptionPane.showMessageDialog(null,"Edit success");
								dispose();
							}
							else if(i_Name.contentEquals("Employe"))
							{
								ScreenMagment.AddEmploye(name.getText(), number.getText(),false);
								JOptionPane.showMessageDialog(null,"Edit success");
								dispose();
							}
						}
						...
						{
							JOptionPane.showMessageDialog(null,"Employe already exists");
						}
					}
					else
					{
